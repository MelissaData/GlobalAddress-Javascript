...
# Global Address Verification API HTML/JavaScript REST Sample Code

This is a sample code for Melissa's Global Address Verification API. It is written in HTML and JavaScript and accesses the API through REST. 
This sample is intended to show the functionality of the Global Address Verification Web Service and how to call the service in HTML/JavaScript. 
...
To subscribe to the Global Address Verification Web Service, please contact our sales department at 800-MELISSA ext. 3 (800-635-4772 ext. 3).
...
Global Address Verification Web Service is a trademark and 1-800-MELISSA is a registered trademark
